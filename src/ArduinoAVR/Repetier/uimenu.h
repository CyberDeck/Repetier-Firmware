...
#ifdef DRV_TMC2130
UI_PAGE6_T(ui_page5, UI_TEXT_EMPTY_ID, UI_TEXT_NOSDCARD_ID, UI_TEXT_STATUS_ID, UI_TEXT_STATUS_ID, UI_TEXT_STATUS_ID, UI_TEXT_STATUS_ID)
#define UI_TMC2130_PAGES ,&ui_page5
#define UI_TMC2130_PAGES_COUNT 1
#else
#define UI_TMC2130_PAGES
#define UI_TMC2130_PAGES_COUNT 0
#endif
...
*/
#define UI_PAGES {&ui_page1 UI_PRINTTIME_PAGES ,&ui_page4 UI_EXTRUDERS_PAGES UI_TMC2130_PAGES}
// How many pages do you want to have. Minimum is 1.
#define UI_NUM_PAGES 2+UI_PRINTTIME_COUNT+UI_EXTRUDERS_PAGES_COUNT+UI_TMC2130_PAGES_COUNT

...
TRANS(UI_TEXT_LCD_BACKLIGHT_EN);
TRANS(UI_TEXT_LCD_BACKLIGHT_R_EN);
TRANS(UI_TEXT_LCD_BACKLIGHT_G_EN);
TRANS(UI_TEXT_LCD_BACKLIGHT_B_EN);
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS + NUM_EXTRA_TRANSLATIONS] PROGMEM = {
    ...
    FUI_TEXT_LCD_BACKLIGHT_EN,
    FUI_TEXT_LCD_BACKLIGHT_R_EN,
    FUI_TEXT_LCD_BACKLIGHT_G_EN,
    FUI_TEXT_LCD_BACKLIGHT_B_EN
